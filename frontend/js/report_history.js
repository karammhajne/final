document.addEventListener("DOMContentLoaded", () => {
    ...
    // Add event listener to the create report button
    document.getElementById('createReportButton').addEventListener('click', openCreateReportModal);
});
...
function openCreateReportModal() {
    const modalHTML = `
        <div id="createReportModal" class="modal">
            <div class="modal-content">
                <span class="close" id="closeCreateReportModal">&times;</span>
                ...
                <form id="createReportForm">
                    ...
                    <button type="button" id="submitNewReport">Submit</button>
                </form>
            </div>
        </div> 
    `;
    ...
    document.getElementById('closeCreateReportModal').addEventListener('click', closeCreateReportModal);
